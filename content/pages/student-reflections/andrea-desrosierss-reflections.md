...
This audio is courtesy of {{% resource_link "b752aacf-1ae5-4f03-bf7d-2f4bede7010c" "Andrea Desrosiers" %}} on Tumblr and is provided under our Creative Commons license.
...
Out of the entire experience, from ideation to script writing to shooting to editing to repeat, it would be easy for me to stick with the part I feel most comfortable with - the script writing part. But we only get growth when we throw ourselves at the things we suck at. It was reiterated when my sister-in-law (an artist) posted something on Facebook that was a riff on the Ira Glass piece that Elizabeth showed (here: {{% resource_link "41b2a0c7-6d06-4a38-9691-11703f2b060b" "What Ira Glass Explains In 1 - Minute Will Change Your Life Forever. Seriously." %}}), namely that when you create art, often it's pretty bad when you first start out. And because you have good taste, you \*know\* it's bad. And often, that's when people quit, because of that gap between what you want to accomplish and what you did accomplish.
